          ...
          {isD ? (
            ...
            <div key={`cp-${animKey}`} style={{ animation: "blFadeUp .3s ease both" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(200px,1fr))", gap: "12px" }}>
                ...
                <div style={{ ...ic, animation: "blScaleIn .3s ease both" }}><div style={{ fontSize: "30px", fontWeight: 800, color: T.orange600, fontFamily: T.fontDisplay }}>{engine.descuentoCP}%</div><div style={{ marginTop: "3px", color: T.textMuted, fontSize: "12px" }}>Descuento actual</div></div>
                <div style={{ ...ic, animation: "blScaleIn .3s ease both", animationDelay: ".08s" }}><div style={{ fontSize: "26px", fontWeight: 800, color: T.orange600, fontFamily: T.fontDisplay }}>{engine.puntosAcumuladosCP}</div><div style={{ marginTop: "3px", color: T.textMuted, fontSize: "12px" }}>Pts acumulados</div>{engine.siguienteNivelCP && <ProgressBar current={engine.puntosAcumuladosCP} target={engine.siguienteNivelCP.meta} label={`${engine.puntosAcumuladosCP}/${engine.siguienteNivelCP.meta} → ${engine.siguienteNivelCP.etiqueta}`} />}</div>
