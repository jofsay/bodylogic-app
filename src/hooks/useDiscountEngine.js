...
export function useDiscountEngine({
  ...
  const estado = useMemo(() => {
    if (perfilUsuario === "ventas") return { texto: "Nota de venta al público.", colorFondo: "#ecfccb", colorTexto: "#3f6212", colorBorde: "#84cc16", colorSemaforo: "#65a30d", mensajePrincipal: "Venta al público", mensajeSecundario: "" };
  ...
  const textoModo = (() => {
    if (perfilUsuario === "ventas") return "Venta al público";
